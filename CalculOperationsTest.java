...
import java.net.URL;
public class CalculOperationsTest {
  ...
  public void testAddition() {
    ...
    driver.manage().window().setSize(new Dimension(992, 824));
    ...
    assertThat(driver.findElement(By.id("result")).getText(), is("Résultat : 10"));
    driver.close();
  }
  @Test
  ...
  public void testMultiplication() {
    driver.get("https://safatelli.github.io/tp-test-logiciel/assets/calc.html");
    driver.manage().window().setSize(new Dimension(998, 824));
    driver.findElement(By.id("num1")).click();
    driver.findElement(By.id("num1")).sendKeys("10");
    driver.findElement(By.id("operator")).click();
    {
  ...
  public void testSoustraction() {
    driver.get("https://safatelli.github.io/tp-test-logiciel/assets/calc.html");
    driver.manage().window().setSize(new Dimension(996, 824));
    driver.findElement(By.id("num1")).click();
